...
<header class="header1">
    ...
    <div class="nav-buttons">
        <a href="profile.php" class="btn btn-secondary text-uppercase">Profile</a>
        <a href="help.php" class="btn btn-secondary text-uppercase">Help</a>
    </div>
</header>
...
<header class="header" id="header">
    <div class="container">
        <div class="header-content text-center">
            <h6 class="text-uppercase text-blue-mid fs-20 fw-6 ls-1">online resume builder</h6>
            <h1 class="lg-title">Supercharge your career and save time with our resume builder</h1>
    ...
    <div class="container">
        <div class="section-one-content">
            ...
            <div class="section-one-r text-center">
                ...
                <p class="text">
                    Getting that dream job can seem like an impossible task. We're here to change that. Give yourself a real advantage with the best online resume maker: created by experts, imporved by data, trusted by millions of professionals. Create your resume in minutes with Resume Revolution's free resume builder. Download it to your computer or use it to apply for any job.
                </p>
                <div class="btn-group">
                    <a href="templates.php" class="btn btn-primary text-uppercase">create my resume</a>
                </div>
